...
What I wanted is a WYSIWYG editor for editing content with styles like bold, cold, list and so on. I do not want to save HTML direct into database. So Textile seems a good choose. Sanskrit can meet most commands, except list, colors, link, image and word escape. Which exactly are what I need. 


Check [here](https://github.com/zhangzhe/g_editor "here") for more details. I will also use the editor on this blog:) 
...
Afterward<br>
later on, I found a more light weight textile editor from Redmine. After simple modification, I got [this](https://github.com/zhangzhe/geditor "this") . I would like to recommend this one unless editing complex format articles. 
